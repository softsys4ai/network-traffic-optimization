...
from src.LSTM import Preprocess, Architecture
...
def hypervolume_improvement(X, X_sample,
                         Y_sample, gpr, xi=0.01):
...
if __name__=="__main__":
    ...
    for i in range(n_iter):
        ...
        X_next = propose_location(hypervolume_improvement, X_sample, Y_sample, gpr, bounds)
